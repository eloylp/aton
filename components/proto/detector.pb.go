...
type CapturerType int32

const (
	CapturerType_CAPTURER_TYPE_FACE   CapturerType = 0
	CapturerType_CAPTURER_TYPE_OBJECT CapturerType = 1
)

// Enum value maps for CapturerType.
var (
	CapturerType_name = map[int32]string{
		0: "CAPTURER_TYPE_FACE",
		1: "CAPTURER_TYPE_OBJECT",
	}
	CapturerType_value = map[string]int32{
		"CAPTURER_TYPE_FACE":   0,
		"CAPTURER_TYPE_OBJECT": 1,
	}
)

func (x CapturerType) Enum() *CapturerType {
	p := new(CapturerType)
	*p = x
	return p
}

func (x CapturerType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (CapturerType) Descriptor() protoreflect.EnumDescriptor {
	return file_components_proto_detector_proto_enumTypes[0].Descriptor()
}

func (CapturerType) Type() protoreflect.EnumType {
	return &file_components_proto_detector_proto_enumTypes[0]
}

func (x CapturerType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use CapturerType.Descriptor instead.
func (CapturerType) EnumDescriptor() ([]byte, []int) {
...
type Status struct {
	...
	DetectionType CapturerType `protobuf:"varint,3,opt,name=detection_type,json=detectionType,proto3,enum=proto.CapturerType" json:"detection_type,omitempty"`
}
...
func (x *Status) GetDetectionType() CapturerType {
	if x != nil {
		return x.DetectionType
	}
	return CapturerType_CAPTURER_TYPE_FACE
}
...
func (x *Result) GetCapturerUuid() string {
	if x != nil {
...
type Capturer struct {
	...
	Type   CapturerType   `protobuf:"varint,4,opt,name=type,proto3,enum=proto.CapturerType" json:"type,omitempty"`
}
...
func (x *Capturer) GetType() CapturerType {
	if x != nil {
		return x.Type
	}
	return CapturerType_CAPTURER_TYPE_FACE
...
type AddCapturerRequest struct {
	...
	CapturerType CapturerType `protobuf:"varint,3,opt,name=capturer_type,json=capturerType,proto3,enum=proto.CapturerType" json:"capturer_type,omitempty"`
}
...
func (x *AddCapturerRequest) GetCapturerType() CapturerType {
	if x != nil {
...
var file_components_proto_detector_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x45, 0x52, 0x56, 0x49, 0x4e, 0x47, 0x10, 0x02, 0x2a, 0x40, 0x0a, 0x0c, 0x43, 0x61, 0x70, 0x74,
	0x75, 0x72, 0x65, 0x72, 0x54, 0x79, 0x70, 0x65, 0x12, 0x16, 0x0a, 0x12, 0x43, 0x41, 0x50, 0x54,
	0x55, 0x52, 0x45, 0x52, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x46, 0x41, 0x43, 0x45, 0x10, 0x00,
	0x12, 0x18, 0x0a, 0x14, 0x43, 0x41, 0x50, 0x54, 0x55, 0x52, 0x45, 0x52, 0x5f, 0x54, 0x59, 0x50,
	0x45, 0x5f, 0x4f, 0x42, 0x4a, 0x45, 0x43, 0x54, 0x10, 0x01, 0x2a, 0x4e, 0x0a, 0x0e, 0x43, 0x61,
	...
	0x4f, 0x4e, 0x5f, 0x52, 0x45, 0x54, 0x52, 0x59, 0x10, 0x01, 0x32, 0xd3, 0x02, 0x0a, 0x08, 0x44,
	...
	,
	...
	0x27, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x65, 0x6c, 0x6f, 0x79,
	0x6c, 0x70, 0x2f, 0x61, 0x74, 0x6f, 0x6e, 0x2f, 0x63, 0x6f, 0x6d, 0x70, 0x6f, 0x6e, 0x65, 0x6e,
...
var file_components_proto_detector_proto_goTypes = []interface{}{
	(CapturerType)(0),                      // 0: proto.CapturerType
	(CapturerStatus)(0),                    // 1: proto.CapturerStatus
	...
	(*Capturer)(nil),                       // 7: proto.Capturer
	(*AddCapturerRequest)(nil),             // 8: proto.AddCapturerRequest
	(*RemoveCapturerRequest)(nil),          // 9: proto.RemoveCapturerRequest
...
var file_components_proto_detector_proto_depIdxs = []int32{
	...
	7,  // 1: proto.Status.capturers:type_name -> proto.Capturer
	0,  // 2: proto.Status.detection_type:type_name -> proto.CapturerType
	13, // 3: proto.Result.recognized_at:type_name -> google.protobuf.Timestamp
	1,  // 4: proto.Capturer.status:type_name -> proto.CapturerStatus
	0,  // 5: proto.Capturer.type:type_name -> proto.CapturerType
	0,  // 6: proto.AddCapturerRequest.capturer_type:type_name -> proto.CapturerType
	...
	8,  // 11: proto.Detector.AddCapturer:input_type -> proto.AddCapturerRequest
	9,  // 12: proto.Detector.RemoveCapturer:input_type -> proto.RemoveCapturerRequest
	...
	14, // 18: proto.Detector.AddCapturer:output_type -> google.protobuf.Empty
	14, // 19: proto.Detector.RemoveCapturer:output_type -> google.protobuf.Empty
